...
@Component
public class FindAllUploadedAfterDateStrategy implements FileSearchStrategy {
    ...
    @Override
    public String getCriteriaKey() { return "uploadedAfter"; }

    @Override
    public Specification<File> getSpecification(String searchValue) {
        Instant cutoffInstant = parseFlexibleDate(searchValue, false);
        return (root, query, cb) -> cb.greaterThanOrEqualTo(root.get("uploadedAt"), cutoffInstant);
    }
